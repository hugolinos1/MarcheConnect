              ...
              <div className="p-8 flex flex-col md:flex-row items-center gap-8 bg-white">
                ...
                <div className="space-y-4 text-center md:text-left flex-1">
                  ...
                  <div className="flex flex-wrap justify-center md:justify-start gap-2 pt-4">
                    <Button variant="outline" size="sm" className="gap-2 border-secondary text-secondary hover:bg-secondary/10 rounded-full px-4 h-8 text-[11px]" asChild>
                      <a href="https://www.unjardinpourfelix.org/" target="_blank" rel="noopener noreferrer">
                        <Info className="w-3.5 h-3.5" /> Blog
                      </a>
                    </Button>
                    <Button variant="outline" size="sm" className="gap-2 border-primary text-primary hover:bg-primary/10 rounded-full px-4 h-8 text-[11px]" asChild>
                      <a href="https://www.lemarchedefelix.com/" target="_blank" rel="noopener noreferrer">
                        <ShoppingBag className="w-3.5 h-3.5" /> Boutique
                      </a>
                    </Button>
                    <Button variant="outline" size="sm" className="gap-2 border-blue-600 text-blue-600 hover:bg-blue-600/10 rounded-full px-4 h-8 text-[11px]" asChild>
